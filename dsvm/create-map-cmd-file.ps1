...
Add-Content 'C:\Users\default\Desktop\mapdrive.cmd' "cmdkey /add:$storageAccountName.file.core.windows.net /user:$shareName /pass:%key%"
Add-Content 'C:\Users\default\Desktop\mapdrive.cmd' "net use s: \\$storageAccountName.file.core.windows.net\dsvmshare /u:$shareName /persistent:yes"
